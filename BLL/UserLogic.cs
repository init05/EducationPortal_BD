...
public class UserLogic
{
    ...
    public async Task Register(string username, string password, string conformationPassword, string email, bool root)
    {
        User newUser = new User(username, password, conformationPassword, email, root);
        try
        {
